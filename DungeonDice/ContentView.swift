...
//  DungeonDice
//
//  Created by TheForce on 3/28/23.
//
...
struct ContentView: View {
    ...
    let spacing: CGFloat = 0 //betweem buttons
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            .onChange(of: geo.size.width, perform: { newValue in
                arrangeGrideItems(deviceWidth: geo.size.width)
            })
    ...
    func arrangeGrideItems(deviceWidth: CGFloat) {
        ...
        let numberOfuttonsPerRow = Int(screenWidth) / Int(buttonWidth + spacing)
        buttonsLeftOver = Dice.allCases.count % numberOfuttonsPerRow
        //print("numberOFbuttonsPerRow = \(numberOfuttonsPerRow)")
